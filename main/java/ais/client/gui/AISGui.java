...
public class AISGui extends InventoryEffectRenderer {
    ...
    public AISGui(EntityPlayer player)
    {
        super(new AISContainerExpanded(player.inventory, !player.worldObj.isRemote, player));
    ...
    {
    	try {
			((AISContainerExpanded)inventorySlots).ais.blockEvents=false;
		} catch (Exception e) {	}
    }
	...
	protected void keyTyped(char par1, int par2) {
		if (par2 == ais.proxy.keyHandler.key.getKeyCode())
        {
